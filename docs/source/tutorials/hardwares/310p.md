...
```{note}
1. The current release supports `FULL_DECODE_ONLY` graph mode on Atlas 300I DUO devices, with some limitations. See the graph mode note below for details.
2. Atlas 300I DUO does not support `triton` or `triton-ascend`.
```
...
• - Qwen3-8B-W8A8SC-310
  ...
  • https://www.modelscope.cn/models/Eco-Tech/Qwen3-8B-w8a8sc-310-vllm

• - Qwen3-14B-W8A8SC-310

  • https://www.modelscope.cn/models/Eco-Tech/Qwen3-14B-w8a8sc-310-vllm
